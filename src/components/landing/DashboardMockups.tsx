    ...
    <div className="relative z-20 w-full max-w-5xl mx-auto -mt-24 lg:-mt-32 pointer-events-none select-none h-auto lg:h-[400px] px-4 md:px-0">
      ...
      <div className="hidden lg:block absolute left-0 lg:-left-4 xl:-left-12 top-12 z-20 w-[360px] bg-[#f8f9fb] rounded-[24px] p-5 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] border border-gray-200/60 text-left">
        <div className="flex justify-between items-center mb-4 px-2">
          <h3 className="text-lg font-bold text-gray-900">Group 1</h3>
          <span className="text-xs font-medium text-gray-500">5/5 members</span>
        </div>
        <div className="space-y-3">
          {[
            ...
            <div key={i} className="flex items-center justify-between bg-white p-3.5 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="w-6 h-6 rounded-full border-2 border-gray-200 flex items-center justify-center text-gray-400">
      ...
      <div className="relative w-full max-w-[580px] mx-auto lg:mx-0 lg:absolute lg:right-0 lg:-right-4 xl:-right-12 lg:top-0 z-10">
        ...
        <div className="w-full bg-white rounded-[24px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] border border-gray-200/60 overflow-hidden text-left flex flex-col">
          ...
          <div className="bg-[#f8f9fb] px-4 py-3.5 flex items-center gap-2 border-b border-gray-100">
            ...
            <p className="text-xs font-medium text-gray-500 mx-auto mr-14">Live Event Dashboard</p>
          </div>
          
          <div className="p-5 sm:p-7">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900">Startup Weekend Hackathon</h2>
            <p className="text-[11px] sm:text-xs text-gray-500 mt-1.5 font-medium">42 of 60 slots filled · 3 groups complete</p>

            <div className="grid grid-cols-3 gap-3 sm:gap-4 mt-6">
              <div className="bg-[#f4f6fa] rounded-2xl p-2.5 sm:p-3.5 text-center border border-gray-100">
                <p className="text-lg sm:text-xl font-bold text-blue-600 mb-1">42</p>
                <p className="text-[10px] sm:text-xs text-gray-500 font-medium">Joined</p>
              </div>
              <div className="bg-[#f4f6fa] rounded-2xl p-2.5 sm:p-3.5 text-center border border-gray-100">
                <p className="text-lg sm:text-xl font-bold text-green-500 mb-1">3</p>
                <p className="text-[10px] sm:text-xs text-gray-500 font-medium">Complete</p>
              </div>
              <div className="bg-[#f4f6fa] rounded-2xl p-2.5 sm:p-3.5 text-center border border-gray-100">
                <p className="text-lg sm:text-xl font-bold text-red-500 mb-1">18</p>
                <p className="text-[10px] sm:text-xs text-gray-500 font-medium">Open</p>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-3 sm:space-y-4">
              ...
              <div className="border border-gray-100 rounded-2xl p-3.5 sm:p-4 shadow-sm relative bg-white">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="text-xs sm:text-[13px] font-bold text-gray-800">Group 1</h4>
              ...
              <div className="border border-gray-100 rounded-2xl p-3.5 sm:p-4 shadow-sm relative bg-white">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="text-xs sm:text-[13px] font-bold text-gray-800">Group 2</h4>
                  <span className="text-[9px] sm:text-[10px] font-bold text-[#e85d04] bg-[#ffeed9] px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full">2 of 4</span>
                </div>
                <div className="flex gap-1.5 sm:gap-2 flex-wrap">
                  <span className="text-[10px] sm:text-[11px] font-semibold text-blue-700 bg-blue-100 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-lg">Dev</span>
                  <span className="text-[10px] sm:text-[11px] font-semibold text-blue-700 bg-blue-100 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-lg">Dev</span>
                  <span className="text-[10px] sm:text-[11px] font-semibold text-gray-600 bg-gray-200 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-lg">Designer</span>
                  <span className="text-[10px] sm:text-[11px] font-semibold text-gray-600 bg-gray-200 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-lg">PM</span>
                </div>
              </div>
              {/* Group 3 */}
              <div className="border border-gray-100 rounded-2xl p-3.5 sm:p-4 shadow-sm relative bg-white">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="text-xs sm:text-[13px] font-bold text-gray-800">Group 3</h4>
                  <span className="text-[9px] sm:text-[10px] font-bold text-[#e85d04] bg-[#ffeed9] px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full">1 of 4</span>
                </div>
                <div className="flex gap-1.5 sm:gap-2 flex-wrap">
                  <span className="text-[10px] sm:text-[11px] font-semibold text-blue-700 bg-blue-100 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-lg">Dev</span>
                  <span className="text-[10px] sm:text-[11px] font-semibold text-gray-600 bg-gray-200 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-lg">Dev</span>
                  <span className="text-[10px] sm:text-[11px] font-semibold text-gray-600 bg-gray-200 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-lg">Designer</span>
                  <span className="text-[10px] sm:text-[11px] font-semibold text-gray-600 bg-gray-200 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-lg">PM</span>
                </div>
              </div>
        ...
        <div className="absolute right-[-4px] sm:right-[-10px] lg:-right-10 xl:-right-16 top-[-24px] sm:top-[-30px] z-30 w-[200px] sm:w-[260px] bg-[#f8f9fb] rounded-2xl p-3 sm:p-4 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.15)] border border-gray-200/80 text-left">
          <h4 className="text-[10px] sm:text-[11px] font-bold text-gray-900 mb-2.5">Position #3</h4>
          <div className="bg-white rounded-xl p-2 sm:p-2.5 border border-gray-100 flex items-center gap-2.5 sm:gap-3 shadow-sm">
            ...
            <div>
              ...
              <p className="text-[9px] sm:text-[10px] text-gray-400 mt-0.5 font-medium">Available</p>
            </div>
          </div>
        </div>
      </div>
