  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <nav className="relative flex items-center justify-between px-4 py-4 md:px-6 max-w-7xl mx-auto z-50">
        ...
        {/* Mobile Menu Button */}
        <div
          className="md:hidden text-gray-600 focus:outline-none p-2 cursor-pointer"
      ...
      <main className="flex flex-col  sm:items-center sm:justify-center sm:text-center px-4 mt-12 mb-20 md:mt-20 md:mb-32">
        ...
        <div className="flex flex-col w-full sm:w-auto sm:flex-row gap-4">
          <Link
            href="/sign-up"
            className="sm:px-8 sm:py-4 px-4 py-2 text-lg font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-center flex items-center justify-center"
          >
            Create Balanced Pairings
          </Link>
          <div
            className="sm:px-8 text-center sm:py-4 px-4 py-2 text-lg font-semibold text-gray-700 bg-gray-50 border border-gray-200 rounded-xl hover:bg-gray-100 transition-all cursor-pointer flex items-center justify-center"
