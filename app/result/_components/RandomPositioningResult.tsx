    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-2">
        ...
        <StatsCard
          title="Filled"
          value={filledCount}
          description={`${capacityPct}% capacity`}
          variant="indigo"
        />
                  ...
                  <tbody className="divide-y divide-gray-100 font-medium text-gray-700">
                    {paginatedParticipants.map((p, idx) => {
                      ...
                      return (
                        <tr
                          key={p.id}
                          className={`hover:bg-gray-50/40 transition-colors ${isRowSelected ? "bg-blue-50/10" : ""
                            }`}
                        >
                          ...
                          <td className="py-4 px-6">
                            <span className={`px-3 py-1 rounded-full text-[10px] font-bold border ${p.assignedNumber
